...
use reflections::render_reflection;
// use reflections::adaptive_sample;
// use reflections::KeyValue;
// use reflections::OrdFloat;

fn main() {
    render_reflection(0.0, 0.0, 640, 480, 0.0, "t".to_string(), "60".to_string(), "t".to_string(), "(t/10)^2".to_string(), "quads".to_string(), 2.0, -1.0, 0.0);
